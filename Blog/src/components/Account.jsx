          ...
          <div className="relative inline-block">
            ...
            >
              ...
              <button
                ...
                className="block w-full rounded px-3 py-2 text-left text-sm text-fadeHeading hover:bg-primaryColor hover:text-white dark:text-dark-6 dark:hover:bg-dark-3"
              >
                Sign Out
              </button>
            </div>
